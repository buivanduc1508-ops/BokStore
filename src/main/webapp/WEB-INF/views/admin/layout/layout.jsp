...
<link rel="stylesheet"
	href="<c:url value="/assets/vendors/simple-datatables/style.css"/>">

<link rel="stylesheet"
	href="<c:url value="/assets/vendors/perfect-scrollbar/perfect-scrollbar.css"/>">
<link rel="stylesheet"
	href="<c:url value="/assets/vendors/bootstrap-icons/bootstrap-icons.css"/>">
<link rel="stylesheet" href="<c:url value="/assets/css/app.css"/>">
<link rel="shortcut icon"
	href="<c:url value="/assets/images/favicon.svg"/>" type="image/x-icon">
</head>
...
<body>
				...
				<div class="sidebar-menu">
					<ul class="menu">
						...
						<li class="sidebar-item active "><a
							href="table-datatable.html" class='sidebar-link'> <i
	...
	<script
		src="<c:url value="/assets/vendors/perfect-scrollbar/perfect-scrollbar.min.js"/>"></script>
	<script src="<c:url value="/assets/js/bootstrap.bundle.min.js"/>"></script>

	<script
		src="<c:url value="/assets/vendors/simple-datatables/simple-datatables.js"/>"></script>
	<script>
		// Simple Datatable
