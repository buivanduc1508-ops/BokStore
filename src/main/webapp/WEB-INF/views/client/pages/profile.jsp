...
<section class="container content-section auth-grid">
  <form method="post">
    <h1>
      Thông tin cá nhân
    </h1>
    ...
    <input name="phone" value="<%=u.getPhone()%>">
    <input name="address" value="<%=u.getAddress()%>">
    <button>
      Lưu
    </button>
  </form>
  <form method="post">
    ...
    <input type="password" name="oldPassword" required placeholder="Mật khẩu hiện tại">
