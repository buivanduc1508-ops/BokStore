...
public class Book implements Serializable {
    ...
    public Book(int id, String name, String author, String publisher, long price, String image,
            String description, int categoryId, int stock) {
        this.id=id; this.name=name; this.author=author; this.publisher=publisher; this.price=price;
        this.image=image; this.description=description; this.categoryId=categoryId; this.stock=stock;
    }
    ...
    public int getSold(){return sold;} public void setSold(int v){sold=v;}
